...
Assert-Contains $configFile 'GodSystemConfig.Version = "1.16.30"'
Assert-Contains (Join-Path $modRoot "mod.info") "1.16.30"
Assert-Contains (Join-Path $modRoot "42\mod.info") "1.16.30"

Write-Output "GodSystem v1.16.30 static feature checks passed."
