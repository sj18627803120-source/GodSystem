...
$LocalizationGenerator = 'C:\Users\Admin\Desktop\PJ\GodSystem_DevHandoff_CN\tools\generate_godsystem_v11645_localization.py'
...
$LuaExe = 'C:\Users\Admin\Tools\Lua51\lua.exe'
if (Test-Path -LiteralPath $LuaExe) {
    & $LuaExe 'C:\Users\Admin\Desktop\PJ\Test-GodSystemV11653Runtime.lua'
