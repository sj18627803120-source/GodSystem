...
Require-Text $config 'GodSystemConfig\.Version\s*=\s*"1\.16\.50"' 'Config version must be 1.16.50'
Require-Text $rootInfo '(?m)^modversion=1\.16\.50$' 'Root mod.info version must be 1.16.50'
Require-Text $b42Info '(?m)^modversion=1\.16\.50$' 'B42 mod.info version must be 1.16.50'
Require-Text $workshop '(?m)^description=v1\.16\.50$' 'Workshop metadata must mention v1.16.50'
...
Write-Output 'Test-GodSystemV11650 passed'
