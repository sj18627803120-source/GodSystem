...
GodSystemConfig.HomeSafeZoneScanIntervalHours = 1
GodSystemConfig.HomeSafeZoneScanBudget = 256
GodSystemConfig.HomeSafeZoneClearLimit = 64
...
GodSystemConfig.StorageContainerFullType = "GodSystem.StorageContainer"
...
-- enumeration is delayed or omits a newly loaded module from its first page.
GodSystemConfig.ItemConfigPinnedFullTypes = {
    ...
    "GodSystem.LotteryTicketTenRandom",
}
