...
local CALLERS = {
    ...
    CalculateVisionBlocked = function(target, ...) return target:CalculateVisionBlocked(...) end,
    contains = function(target, ...) return target:contains(...) end,
    ...
    getCell = function(target, ...) return target:getCell(...) end,
    ...
    getForwardDirection = function(target, ...) return target:getForwardDirection(...) end,
    ...
    getObsolete = function(target, ...) return target:getObsolete(...) end,
    ...
    getItemType = function(target, ...) return target:getItemType(...) end,
    ...
    getStaticMovingObjects = function(target, ...) return target:getStaticMovingObjects(...) end,
    ...
    getVehicle = function(target, ...) return target:getVehicle(...) end,
    ...
    getZombieList = function(target, ...) return target:getZombieList(...) end,
    ...
    isAiming = function(target, ...) return target:isAiming(...) end,
    isAttacking = function(target, ...) return target:isAttacking(...) end,
    ...
    isDead = function(target, ...) return target:isDead(...) end,
    ...
    isHidden = function(target, ...) return target:isHidden(...) end,
    ...
    isRunning = function(target, ...) return target:isRunning(...) end,
    isSprinting = function(target, ...) return target:isSprinting(...) end,
    isPlayerMoving = function(target, ...) return target:isPlayerMoving(...) end,
    isOnFloor = function(target, ...) return target:isOnFloor(...) end,
    isStale = function(target, ...) return target:isStale(...) end,
    isbFalling = function(target, ...) return target:isbFalling(...) end,
    ...
    removeAttachedItem = function(target, ...) return target:removeAttachedItem(...) end,
    removeFromHands = function(target, ...) return target:removeFromHands(...) end,
    removeWornItem = function(target, ...) return target:removeWornItem(...) end,
    removeCorpse = function(target, ...) return target:removeCorpse(...) end,
    Remove = function(target, ...) return target:Remove(...) end,
    transmitRemoveItemFromSquare = function(target, ...) return target:transmitRemoveItemFromSquare(...) end,
    setAdditionalPain = function(target, ...) return target:setAdditionalPain(...) end,
    setAttachedItem = function(target, ...) return target:setAttachedItem(...) end,
    setAlwaysKnockedDown = function(target, ...) return target:setAlwaysKnockedDown(...) end,
    ...
    setKnockedDown = function(target, ...) return target:setKnockedDown(...) end,
    ...
    setPrimaryHandItem = function(target, ...) return target:setPrimaryHandItem(...) end,
    setSecondaryHandItem = function(target, ...) return target:setSecondaryHandItem(...) end,
    setWornItem = function(target, ...) return target:setWornItem(...) end,
    ...
    setZ = function(target, ...) return target:setZ(...) end,
