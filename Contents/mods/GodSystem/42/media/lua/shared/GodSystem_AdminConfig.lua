...
local SETTING_META = {
    ...
    { key = "CarryCapacityBaseCost", group = "base", type = "integer", default = Config.CarryCapacityBaseCost or 2000, min = 1, max = 100000000, target = "CarryCapacityBaseCost", labelKey = "AdminSetting_CarryCapacityBaseCost", descKey = "AdminSetting_CarryCapacityBaseCost_Desc" },
    { key = "CarryCapacityCostMultiplier", group = "base", type = "number", default = Config.CarryCapacityCostMultiplier or 1.5, min = 1, max = 100, target = "CarryCapacityCostMultiplier", labelKey = "AdminSetting_CarryCapacityCostMultiplier", descKey = "AdminSetting_CarryCapacityCostMultiplier_Desc" },
    ...
    { key = "TerminalPhase2UpgradeCost", group = "base", type = "integer", default = Config.TerminalPhase2UpgradeCost or 2000, min = 0, max = 100000000, target = "TerminalPhase2UpgradeCost", labelKey = "AdminSetting_TerminalPhase2UpgradeCost", descKey = "AdminSetting_TerminalPhase2UpgradeCost_Desc" },
    { key = "TerminalPhase2CapacityMaxOffset", group = "base", type = "integer", default = Config.TerminalPhase2CapacityMaxOffset or 5000, min = 0, max = 5000, target = "TerminalPhase2CapacityMaxOffset", labelKey = "AdminSetting_TerminalPhase2CapacityMaxOffset", descKey = "AdminSetting_TerminalPhase2CapacityMaxOffset_Desc" },
